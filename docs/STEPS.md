...
```
An complete source code is available at [../simple-loan-validation-res-runnersrc/main/java/com/ibm/decisions/loanvalidation/LoanValidationRESRunner.java](../simple-loan-validation-res-runnersrc/main/java/com/ibm/decisions/loanvalidation/LoanValidationRESRunner.java)
